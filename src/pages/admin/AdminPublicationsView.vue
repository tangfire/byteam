<template>
  <AdminCrudView title="Publications" description="管理论文、链接和首页精选论文" resource="publications" :defaults="defaults" :columns="columns" :fields="fields" />
</template>

<script setup lang="ts">
import AdminCrudView, { type FieldConfig } from '../../components/admin/AdminCrudView.vue'

const defaults = { image: '', title: '', authors: '', venue: '', year: new Date().getFullYear(), kind: 'conference', status: 'published', featured: false, sortOrder: 0, links: [] }
