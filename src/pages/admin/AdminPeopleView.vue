<template>
  <AdminCrudView title="成员管理" description="管理研究生、研究生校友和本科生校友" resource="people" :defaults="defaults" :columns="columns" :fields="fields" sortable sort-group-key="category" />
</template>
