...
const defaults = { title: '', content: '', excerpt: '', type: 'publication', typeLabel: 'Publication', date: '', color: '#7d1231', status: 'published', sortOrder: 0 }
const columns: FieldConfig[] = [
  { prop: 'date', label: '日期', width: 120 },
  { prop: 'title', label: '标题', width: 260 },
  { prop: 'typeLabel', label: '类型', width: 120 },
